...
{
    public class ThreadViewModel : ViewModelBase, INavigableViewModel, IAmbientColor, IBackAwareViewModel
    {
        ...
        private RelayCommand<MessageRecord> _testCommand;
        public RelayCommand<MessageRecord> TestCommand
        {
            get
            {
                return _testCommand ?? (_testCommand = new RelayCommand<MessageRecord>(
                    (m) =>
                    {
                        try
                        {
                            //TileHelper.Update();
                            ToastHelper.NewMessage(m);
                        }
                        catch (Exception e)
                        {
                            // TODO:
        ...
        {
            Log.Debug($"Back from Thread");
            args.Handled = true; // backbutton handler takes care
