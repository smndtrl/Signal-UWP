...
namespace libaxolotl_test.ratchet
{
    ...
    public class RatchetingSessionTest
    {
        ...
        public void testRatchetingSessionAsBob()
        {
            ...
            Assert.IsTrue(session.getLocalIdentityKey().Equals(bobIdentityKey.getPublicKey()));
            Assert.IsTrue(session.getRemoteIdentityKey().Equals(aliceIdentityPublicKey));
        ...
        public void testRatchetingSessionAsAlice()
        {
            ...
            byte[] receiverChain = {
            (byte)0xd2, (byte)0x2f, (byte)0xd5, (byte)0x6d, (byte)0x3f,
                                    (byte)0xec, (byte)0x81, (byte)0x9c, (byte)0xf4, (byte)0xc3,
                                    (byte)0xd5, (byte)0x0c, (byte)0x56, (byte)0xed, (byte)0xfb,
                                    (byte)0x1c, (byte)0x28, (byte)0x0a, (byte)0x1b, (byte)0x31,
                                    (byte)0x96, (byte)0x45, (byte)0x37, (byte)0xf1, (byte)0xd1,
            ...
            IdentityKey alsdfsdf = aliceIdentityKey.getPublicKey();
            IdentityKey sl = session.getLocalIdentityKey();

            Assert.IsTrue(session.getLocalIdentityKey().Equals(aliceIdentityKey.getPublicKey()));
            Assert.IsTrue(session.getRemoteIdentityKey().Equals(bobIdentityKey));
            CollectionAssert.AreEqual(session.getReceiverChainKey(bobEphemeralPublicKey).getKey(),
                                 receiverChain);
