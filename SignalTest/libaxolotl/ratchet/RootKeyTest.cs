...
namespace libaxolotl_test.ratchet
{
    ...
    public class RootKeyTest
    {
        ...
        public void testRootKeyDerivationV2()
        {
            ...
            CollectionAssert.AreEqual(rootKey.getKeyBytes(), rootKeySeed, "rootKeySeed doesn't match");
            CollectionAssert.AreEqual(nextRootKey.getKeyBytes(), nextRoot, "nextRootKey doesn't match");
            CollectionAssert.AreEqual(nextChainKey.getKey(), nextChain, "nextChainKey doesn't match");
        }
    }
}
